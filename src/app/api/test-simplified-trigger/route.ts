// Simplified translation trigger yang skip prisma import
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (contentType === 'section') {
      ...
      console.log('🧪 Step 5: Section data prepared:', section.title);
      ...
      console.log('🧪 Step 6: Translation data prepared:', Object.keys(translationData));
      
      // Simplified autoTranslateSection
      ...
      console.log('🧪 Step 7: Calling simplified autoTranslateSection...');
      await simplifiedAutoTranslateSection(contentId, translationData);
      console.log('🧪 Step 8: Simplified autoTranslateSection completed successfully');
